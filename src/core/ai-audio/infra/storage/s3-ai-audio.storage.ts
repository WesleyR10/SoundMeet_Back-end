...
import { IAiAudioStorage } from "../../application/ports/ai-audio-storage.interface";

export class S3AiAudioStorage implements IAiAudioStorage {
  ...
  async putObject(input: {
    ...
    await this.s3
      .upload(
        ...
        {
          partSize: S3AiAudioStorage.DEFAULT_PART_SIZE_BYTES,
          queueSize: S3AiAudioStorage.DEFAULT_QUEUE_SIZE,
        },
      )
      .promise();
  }
