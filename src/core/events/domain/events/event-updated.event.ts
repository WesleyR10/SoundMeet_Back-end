...
export type EventUpdatedEventProps = {
  event_id: EventId;
...
export class EventUpdatedIntegrationEvent implements IIntegrationEvent<
  Omit<EventUpdatedEventProps, "event_id"> & { event_id: string }
> {
  event_version = 1;
  occurred_on = new Date();
  event_name = "event.updated";
  payload: Omit<EventUpdatedEventProps, "event_id"> & { event_id: string };

  constructor(
    props: Omit<EventUpdatedEventProps, "event_id"> & { event_id: string },
  ) {
    this.payload = props;
  }
}

export class EventUpdatedEvent implements IDomainEvent {
  ...
  constructor(props: EventUpdatedEventProps) {
  ...
  getIntegrationEvent() {
    return new EventUpdatedIntegrationEvent({
