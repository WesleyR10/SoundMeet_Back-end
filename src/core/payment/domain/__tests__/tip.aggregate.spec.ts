...
describe("Tip Aggregate", () => {
  it("should create and validate", () => {
    const tip = Tip.create({ audience_id: "123e4567-e89b-12d3-a456-426614174000", musician_id: "123e4567-e89b-12d3-a456-426614174001", amount: 10, payment_method: PaymentMethod.PIX });
    expect(tip.status).toBe(TipStatus.PENDING);
    expect(tip.amount.amount).toBe(10);
  });

  it("should complete and emit event", () => {
    const tip = Tip.create({ audience_id: "123e4567-e89b-12d3-a456-426614174000", musician_id: "123e4567-e89b-12d3-a456-426614174001", amount: 5, payment_method: PaymentMethod.PIX });
    tip.complete("tx-1");
