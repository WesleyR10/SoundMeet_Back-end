...
export type CreateMusicLibraryInputConstructorProps = {
  musician_id: string;
  title: string;
  artist: string;
  genre?: string | null;
...
export class CreateMusicLibraryInput {
  @IsString()
  @IsNotEmpty()
  musician_id: string;
  ...
  constructor(props: CreateMusicLibraryInputConstructorProps) {
    if (!props) return;
...
export class ValidateCreateMusicLibraryInput {
  static validate(input: CreateMusicLibraryInput) {
