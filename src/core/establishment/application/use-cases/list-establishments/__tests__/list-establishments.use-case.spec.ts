      ...
      items: [
        {
          ...
          updated_at: establishments[1].updated_at,
        ...
        },
        {
          ...
          updated_at: establishments[0].updated_at,
      ...
      items: [
        {
          ...
          cnpj: establishments[2].cnpj
            ? {
                formatted: establishments[2].cnpj.formatted,
          ...
          updated_at: establishments[2].updated_at,
        },
        {
          id: establishments[0].establishment_id.id,
          name: "Rock Bar",
